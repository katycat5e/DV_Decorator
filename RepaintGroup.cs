            ...
            foreach( GameObject target in targets )
            {
                ...
                foreach( var renderer in renderers )
                {
                    ...
                    for( int i = 0; i < materials.Length; i++ )
                    {
                        ...
                        //if( materialChanged )
                        //{
                        //    Redecorator.ModEntry.Logger.Log($"Applied new texture to material {ObjectName}.{renderer.name}.{materials[i].name}");
                        //}
                    }
                }
